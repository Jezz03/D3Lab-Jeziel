...
from terrain.rocks import Rocks
from terrain.sand import Sand
from terrain.shallows import Shallows
...
class Map:
    ...
    class __Map:
        ...
        def assign_type(self, ttype: TerrainType) -> None:
            ...
            elif ttype == TerrainType.PLAIN:
                self._map = [[Plain(x, y) for x in range(self._width)] for y in range(self._height)]
            elif ttype == TerrainType.ROCKS:
                self._map = [[Rocks(x, y) for x in range(self._width)] for y in range(self._height)]
            elif ttype == TerrainType.SAND:
                self._map = [[Sand(x, y) for x in range(self._width)] for y in range(self._height)]
            elif ttype == TerrainType.SHALLOWS:
                self._map = [[Shallows(x, y) for x in range(self._width)] for y in range(self._height)]
            pass
