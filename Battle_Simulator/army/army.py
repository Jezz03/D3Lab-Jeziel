...
class Army:
    ...
    def _overlap(self, cbox: (float, float)) -> bool:
        ...
        if l1[0] >= r2[0]-1 or l2[0] >= r1[0]-1:
            return False
        # If one rectangle is above other
        if l1[1] >= r2[1]-1 or l2[1] >= r1[1]-1:
            return False
        return True
