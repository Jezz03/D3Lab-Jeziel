...
var circle = svg.append("circle").attr("cx", 200).attr("cy", 250).attr("r", 85).attr("fill", "purple");

var rect = svg.append("rect").attr("x", 0).attr("y", 200).attr("width", 20).attr("height", 200).attr("fill","green");
